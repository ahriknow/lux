...
var hljs = (function () {
    ...
    function K(e, t, { key: n }) {
        ...
        for (let e = 1; e <= t.length; e++)
            ((o[e + i] = s[e]), (r[e + i] = !0), (i += p(t[e - 1])));
        ((e[n] = o), (e[n]._emit = r), (e[n]._multi = !0));
    }
    function F(e) {
        (((e) => {
            e.scope &&
            ...
            ((e) => {
                if (Array.isArray(e.begin)) {
                    if (e.skip || e.excludeBegin || e.returnBegin)
                        throw (
                            z('skip, excludeBegin, returnBegin not compatible with beginScope: {}'),
                            G
                        );
                    if ('object' != typeof e.beginScope || null === e.beginScope)
                        throw (z('beginScope must be object'), G);
                    (K(e, e.begin, { key: 'beginScope' }),
            ...
            ((e) => {
                if (Array.isArray(e.end)) {
                    if (e.skip || e.excludeEnd || e.returnEnd)
                        throw (
                            z('skip, excludeEnd, returnEnd not compatible with endScope: {}'),
                            G
                        );
                    if ('object' != typeof e.endScope || null === e.endScope)
                        throw (z('endScope must be object'), G);
                    (K(e, e.end, { key: 'endScope' }), (e.end = m(e.end, { joinWith: '' })));
                }
            })(e));
    }
    function Z(e) {
        ...
        return (
            ...
            (function n(r, o) {
                ...
                return (
                    ...
                    (c = c || /\w+/),
                    r.keywords && (r.keywords = C(r.keywords, e.case_insensitive)),
    ...
    const J = n,
        ...
        ee = (n) => {
            ...
            function m(e, t, n) {
                ...
                return ((o.code = r.code), N('after:highlight', o), o);
            }
            function E(e, n, s, r) {
                ...
                function l() {
                    ...
                    for (; t;) {
                        ...
                        const s = w.case_insensitive ? t[0].toLowerCase() : t[0],
                            r = ((i = s), N.keywords[i]);
                        if (r) {
                            const [e, i] = r;
                            if (
                ...
                function _(i, r) {
                    ...
                    if ('begin' === y.type && 'end' === r.type && y.index === r.index && '' === a) {
                        if (((R += n.slice(r.index, r.index + 1)), !o)) {
                ...
                let R = '',
                    ...
                    T = !1;
                try {
                    if (w.__emitTokens) w.__emitTokens(n, M);
                    else {
            ...
            function y(e) {
                ...
                const i = t.textContent,
                    r = n ? m(i, { language: n, ignoreIllegals: !0 }) : x(i);
                ((e.innerHTML = r.value),
                    ...
                    N('after:highlightElement', { el: e, result: r, text: i }));
            }
            let _ = !1;
            function w() {
        ...
        te = ee({});
    return ((te.newInstance = () => ee({})), te);
})();
'object' == typeof exports &&
    'undefined' != typeof module &&
    (module.exports = hljs); /*! `bash` grammar compiled for Highlight.js 11.11.1 */
(() => {
    var e = (() => {
        'use strict';
        return (e) => {
            ...
            const a = {
                ...
                i = e.inherit(e.COMMENT(), { match: [/(^|\s)/, /#.*$/], scope: { 2: 'comment' } }),
                c = {
                    begin: /<<-?\s*(?=\w+)/,
                    starts: {
                        contains: [
    ...
    var e = (() => {
        ...
        return (o) => {
            ...
            const S = [].concat(p, y.contains),
                w = S.concat([
                    { begin: /(\s*)\(/, end: /\)/, keywords: g, contains: ['self'].concat(S) },
                ]),
                R = {
                    className: 'params',
                    begin: /(\s*)\(/,
            ...
            return {
                ...
                contains: [
                    ...
                    },
                    {
                        ...
                        contains: [
                            R,
                            o.inherit(o.TITLE_MODE, { begin: d, className: 'title.function' }),
                        ],
                    },
                    { match: /\.\.\./, relevance: 0 },
                    C,
